...
func TestRequestString(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			name: "Normal message",
			request: Request{
				Msg: "Hello, world!", UserID: "123", UserName: "Alice", ChatID: "chat1", Meta: MetaData{
					Images: 2, Links: 1, Mentions: 0, HasVideo: false, HasAudio: false, HasForward: false, HasKeyboard: false,
				}, CheckOnly: false},
			expected: `msg:"Hello, world!", user:"Alice", id:123, chat:chat1, images:2, links:1, mentions:0, has_video:false, has_audio:false, has_forward:false, has_keyboard:false`,
		},
		{
			name: "Spam message",
			request: Request{
				Msg: "Spam message", UserID: "456", UserName: "Bob", ChatID: "chat2", Meta: MetaData{
					Images: 0, Links: 3, Mentions: 2, HasVideo: true, HasAudio: false, HasForward: false, HasKeyboard: false,
				}, CheckOnly: true},
			expected: `msg:"Spam message", user:"Bob", id:456, chat:chat2, images:0, links:3, mentions:2, has_video:true, has_audio:false, has_forward:false, has_keyboard:false`,
		},
		{
			name:     "Empty fields",
			request:  Request{Msg: "", UserID: "", UserName: "", Meta: MetaData{}, CheckOnly: false},
			expected: `msg:"", user:"", id:, chat:, images:0, links:0, mentions:0, has_video:false, has_audio:false, has_forward:false, has_keyboard:false`,
		},
	}
